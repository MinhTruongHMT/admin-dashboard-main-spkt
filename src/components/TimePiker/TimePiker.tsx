...
export default function TimePikerOne({ setTimeStart,setTimeEnd }: { setTimeStart: any ,setTimeEnd:any}) {
    ...
    <div className="flex justify-between border p-2">
      ...
      <div>
        <div className="">
          ...
          <div className="relative z-20 bg-white dark:bg-form-input mb-5">
          ...
          <div className="relative z-20 bg-white dark:bg-form-input">
            <div className="flex items-center">
              ...
              <select
                ...
                onChange={(e) => {
                  setSelectedStyleH1(e.target.value);
                  changeTextColor();
                }}
                className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-2 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input ${
                  isOptionSelected3 ? "text-black dark:text-white" : ""
      ...
      className="border p-2 "
        onClick={() => {
            setTimeStart(selectedOption + ":" + selectedMinute + ":" + selectedStleH);
            setTimeEnd(selectedOption1 + ":" + selectedMinute1 + ":" + selectedStleH1);
        }}
      >
        Ok
      </button>
